...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int v = 0; v < getNumVertices(); v++) {
			sequence.add(getNeighbors(v).size() + getInNeighbors(v).size());
		}
	...
	public static void main (String[] args) {
		GraphLoader.createIntersectionsFile("data/maps/villar_san_costanzo.map", "data/intersections/villar_san_costanzo.intersections");
